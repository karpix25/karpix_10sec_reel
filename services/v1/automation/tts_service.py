...
class ElevenLabsTTSService:
    def __init__(self):
        ...
        self.voice_id = os.getenv("ELEVENLABS_VOICE_ID", "nPczCjzB2oQXqZ4mU67e") # Default: Brian
    ...
    def generate_speech(self, text, stability=0.5, similarity=0.75):
        """
        Generates speech using ElevenLabs API.
        Optimized for 5-minute professional narrations.
        """
        headers = {
        ...
        try:
            ...
            return response.content # Returns raw audio binary
...
if __name__ == "__main__":
    ...
    # Выбираем сервис на основе доступных ключей
    ...
    print(f"Using {provider} for test...")
    try:
        audio_data = service.generate_speech("Привет! Это тест профессиональной озвучки.")
        with open("test_audio.mp3", "wb") as f:
            f.write(audio_data)
        print(f"Success! Saved to test_audio.mp3 via {provider}")
    except Exception as e:
