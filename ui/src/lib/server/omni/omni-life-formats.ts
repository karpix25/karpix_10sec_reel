...
export const OMNI_LIFE_FORMATS: readonly OmniLifeFormat[] = [
  {
    ...
    providerDescription: "стабильная говорящая голова с простыми монтажными перебивками по смыслу реплики",
    ...
    sceneArcs: [arc("talking_head_home_cutaways", "у окна или у чистой домашней стены", [
      { name: "спокойный фон", appearance: "одна светлая домашняя стена или окно без читаемого текста и без лишних предметов", initialPosition: "позади героя на протяжении всех частей" },
      { name: "маленький столик", appearance: "одна чистая светлая поверхность без беспорядка", initialPosition: "сбоку от героя, попадает в перебивки только при необходимости" },
    ], [
