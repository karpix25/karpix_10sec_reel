...
export function buildScriptRetryFeedback(error: unknown) {
  ...
  if (/доступные Omni-длительности|Максимум .* слов|не помещается в доступные/iu.test(message)) {
    return [
      "Предыдущий сценарий слишком длинный для лимита из трех или четырех частей.",
      "Сожми текст максимум до ста слов, сохранив хук, смысл продукта, главный аргумент и CTA.",
      "Удали второстепенные пояснения и повторы, но не выбрасывай CTA и не добавляй новые рекламные обещания.",
      "Верни три или четыре плотных смысловых бита. Поле script и сумма beats.voiceover должны совпадать дословно.",
    ].join(" ");
  }
