...
После первого упоминания продукта CTA должен завершать мысль о его применении, а не прерывать её. После CTA продолжи или заверши исходный тезис reference. Не вставляй отдельный рекламный блок между двумя несвязанными полезными фразами.
