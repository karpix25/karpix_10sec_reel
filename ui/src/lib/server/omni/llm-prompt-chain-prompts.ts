...
Задача: адаптировать исходный reference-сценарий в живой русский voiceover для говорящего человека.
...
Используй исходную транскрибацию reference-видео как почти готовый исходник, а не как отвлеченную тему. Сохрани хук, порядок мыслей, механизм, конкретный пример и финал. Не придумывай новый сюжет или новый угол.
...
Если нужно сократить текст до четырех частей, убирай только повторы, вводные слова и лишнюю многословность. Сначала сохраняй хук и порядок reference, затем объединяй близкие предложения. Не выбрасывай механизм, конкретный пример, доказательство или вывод и не заменяй их общей рекламной фразой.
...
В одном segment продукт должен иметь один логичный физический статус: или на столе, или в руках (если это реплика про продукт), или вне кадра.
