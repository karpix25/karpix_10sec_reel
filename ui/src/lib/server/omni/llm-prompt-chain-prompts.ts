...
function buildDurationLine(durationRange?: OmniDurationRange) {
  ...
  return [
    ...
    "Стремись к этой длине, но не урезай смысл ради верхней границы: если текст естественно длиннее, сохрани его до общего лимита 100 слов, а раскадровка добавит часть. Используй блоки по четыре слова, допускай остаток одно или два слова только в последних кадрах последней части и не создавай больше пяти частей. Каждая граница segment должна приходиться после завершенного предложения, без разрыва союза, предлога или зависимой фразы.",
  ].join(" ");
}
