...
Если хук обещает конкретное место, способ, цену или результат, обязательно назови этот ответ. Для подтверждения достаточно одного конкретного факта или примера из reference. Второй добавляй только когда без него теряется причинная связь или обещанное хуком число пунктов. Не переноси весь список ради формального совпадения.
