...
Не проси новые субтитры. Переходы и эффекты применяй только если они есть в раскадровке, без интерфейса соцсетей и водяных знаков.
...
Усиль динамику UGC: первый кадр с необычным ракурсом или действием, живые жесты, быстрые перебивки, смена крупности, но без рекламной постановки.
Все числа в текстовых значениях JSON пиши словами. Не используй emoji, дефисы, тире или минусы.
