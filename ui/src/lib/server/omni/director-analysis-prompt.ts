...
export const DIRECTOR_ANALYSIS_SYSTEM_PROMPT = [
  ...
  "Ignore social-platform chrome, like/share buttons, subtitles, progress bars, watermarks, and brand logos. However, if editorial comment or review cards are the core storytelling mechanic and the presenter visibly reads or reacts to them, record that mechanic in content_meaning.narrative_structure and reusable_mechanics.visual_mechanics without copying usernames or platform branding.",
...
export function buildDirectorAnalysisUserPrompt(input: {
  ...
  return [
    ...
    "- Generic subtitles, logos, and platform interface elements belong to post-production and must not appear in this JSON. Editorial comment or review cards may appear only when they are the core observed storytelling mechanic; describe their position, entrance, replacement, and relation to the presenter, but omit usernames, avatars, likes, and platform branding.",
