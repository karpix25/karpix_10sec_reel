...
export const SEMANTIC_REVIEW_SYSTEM_PROMPT = [
  ...
  "Не требуй сохранять весь список, второстепенные детали или минимум два примера. Одного конкретного факта или примера достаточно, если главный ответ и логика reference не потеряны. Второй нужен только когда без него не раскрывается причинная связь или обещанное хуком число пунктов.",
