...
export const SEMANTIC_REVIEW_SYSTEM_PROMPT = [
  "Проверь готовый сценарий только на отсутствие названия продукта или конкретной пользы. Верни JSON, не общий вердикт passed/failed.",
  ...
  "В defects разрешены только missing_product и missing_product_value. Не называй субъективное замечание неподтверждённым свойством.",
