...
export const SEMANTIC_REVIEW_SYSTEM_PROMPT = [
  ...
  "finalAnswerPresent означает, что главный вопрос или тезис исходного reference получает завершенный вывод после последнего CTA. Финальная часть не может целиком состоять из призыва.",
