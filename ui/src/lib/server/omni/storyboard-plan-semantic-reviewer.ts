...
export const STORYBOARD_PLAN_REVIEW_SYSTEM_PROMPT = [
  ...
  "В каждом segment обязателен отдельный кадр, где сохранённый аватар физически ведёт повествование: говорит в камеру или присутствует в движении с voiceover. Если исходник целиком состоит из B-roll, в full_reference поставь этот кадр в том же сеттинге; в style_only создай его заново в том же общем визуальном языке.",
