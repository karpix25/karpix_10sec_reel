...
1б. Если нужно сократить текст до четырех частей, сокращай повторы, вводные слова и длинные формулировки, а не идеи. Объединяй близкие предложения в один плотный beat. Не заменяй конкретный механизм, пример или доказательство общей фразой вроде "это полезно" или "помогает лучше себя чувствовать".
...
7. Структура: кульминационный хук 0-3 сек, 2-3 плотных бита, один CTA. Итоговый сценарий должен укладываться в 3-4 части, не создавай пятую часть.
...
function buildDurationInstruction(durationRange?: OmniDurationRange) {
  if (!durationRange) {
    return "Целевая длина сценария: обычно 48-72 слова. Система сама выберет длительность 3-4 частей из 4, 6, 8 или 10 секунд. Никогда не превышай 100 слов: если исходник длиннее, сожми его, сохранив хук, смысл продукта и CTA.";
  }
  ...
  return (
    ...
    "Система сама выберет 3-4 части. Если исходник длиннее лимита, сожми формулировки до верхней границы диапазона, сохранив хук, смысл продукта, ключевые аргументы и CTA. Не добавляй дополнительные части и не пытайся сохранить исходные фразы дословно."
  );
}
