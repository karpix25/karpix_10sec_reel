...
27. Первый beat сохраняет тип и силу original hook, но получает новую сцену. Продукт появляется только в короткой рекламной вставке в середине и только в виде выбранного product reference.
