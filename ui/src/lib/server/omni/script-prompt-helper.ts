...
function buildDurationInstruction(durationRange?: OmniDurationRange) {
  ...
  return (
    ...
    "Система сама выберет 3-4 части. Если исходник длиннее лимита, сожми формулировки, сохранив хук, смысл продукта, ключевые аргументы и CTA. Не добавляй дополнительные части."
  );
}
