...
16. Планируй речь блоками примерно по четыре слова на каждые две секунды: 4с это около 8 слов, 6с это около 12 слов, 8с это около 16 слов, 10с это около 20 слов. Остаток в одно или два слова допустим: система распределит его по последним кадрам последней части. Каждая граница сегмента должна приходиться после завершенного предложения, без разрыва союза, предлога или зависимой фразы.
