...
const VISUAL_STYLE_PROFILES: readonly VisualStyleProfile[] = [
  {
    ...
    visualTone: "живой UGC-разговор без постановочной хореографии, внимание на лице, интонации и доверии",
    cameraLanguage: "телефон 9:16 на уровне глаз, основной кадр лицо и плечи, перебивки короткие и с легким ручным дыханием",
    lighting: "мягкий дневной свет из окна или домашний свет с легкой неровностью, один и тот же тон кожи и одежды во всех частях",
    sceneArc: sceneArc("talking_head_window_cutaways", "у окна или у обычной домашней стены", [
      { name: "жилой фон", appearance: "одна светлая домашняя стена или окно без читаемого текста, с небольшими естественными неровностями комнаты", initialPosition: "позади героя весь ролик" },
      { name: "боковая поверхность", appearance: "одна светлая бытовая поверхность с естественными тенями и мелкими следами использования", initialPosition: "сбоку от героя, используется только для коротких перебивок" },
    ], [
