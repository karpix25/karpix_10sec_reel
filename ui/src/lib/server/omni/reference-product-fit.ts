...
export const REFERENCE_PRODUCT_FIT_PROMPT = [
  ...
  "compatible true только если реальная функция продукта естественно продолжает уже существующую потребность, действие, список или вывод reference.",
  "Если для связи нужно придумать новую проблему, ложную причинность или резко сменить тему на рекламу, compatible false.",
  "Одинаковая страна, аудитория или широкая тема путешествий сами по себе не доказывают совместимость.",
