...
export function buildStoryboardImagePrompt(input: {
  ...
  return [
    ...
    directorReferenceImageUrls.length
      ? `Изображения ${directorRange} - кадры оригинального reference-видео. Используй их для атмосферы, одежды, света, локации, динамики смены кадров и UGC-ракурсов, но не копируй лицо оригинального автора.`
      : "",
