...
const SEMANTIC_REPAIR_SYSTEM_PROMPT = [
  ...
  "Когда productVisibleByFrame для кадра равно false, visualAction и productPlacement не должны называть, показывать, держать или передавать продукт; используй нейтральный тематический B-roll без взаимодействия с предметами.",
].join(" ");
