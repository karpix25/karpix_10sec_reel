...
export function buildCreativeCopywriterRepairPrompt(input: CreativeRepairInput) {
  ...
  return [
    ...
    "Если CTA обязателен, произнеси его до финальной полезной мысли, затем закончи отдельной смысловой фразой.",
...
export function buildCreativeCopywriterRebuildFeedback(input: {
  ...
  return [
    ...
    "Ответь на хук, сохрани основной смысл reference, нативно свяжи продукт с конкретным действием, поставь CTA перед полноценным финальным выводом.",
  ].join(" ");
}
