...
export function buildCreativeCopywriterRepairPrompt(input: CreativeRepairInput) {
  return [
    ...
    "Сохрани удачные фразы и готовые речевые группы. Исправь перечисленные подтвержденные нарушения вместе, затем проверь весь результат. Не меняй тему, исходный ответ или свойства продукта ради сокращения.",
    "Если места не хватает, сокращай повторы и второстепенные подробности, а не ответ на хук или обязательные пункты.",
