...
export function buildCreativeCopywriterRepairPrompt(input: CreativeRepairInput) {
  ...
  return [
    ...
    "Если CTA обязателен, сначала произнеси полноценный вывод, затем CTA отдельной последней фразой.",
...
export function buildCreativeCopywriterRebuildFeedback(input: {
  ...
  return [
    ...
    "Ответь на хук, сохрани основной смысл reference, нативно свяжи продукт с конкретным действием и поставь полноценный вывод перед CTA.",
  ].join(" ");
}
