...
export const OMNI_CLEAN_FRAME_PROMPT =
  "Кадр выглядит как чистое сырое видео напрямую с сенсора камеры: полный экран, реальная сцена, человек, локация, предметы и естественный свет. В кадре полностью отсутствуют любые элементы интерфейса, водяные знаки, наложенный текст, субтитры, кнопки или логотипы. Графическая рамка разрешена только если reference layout явно требует бумажную обводку cutout-аватара.";
