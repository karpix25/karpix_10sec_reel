...
export function renderCompactRussianOmniStoryboardPrompt(input: {
  ...
  return [
    `создай обычное вертикальное 9:16 видео, используя раскадровку только как скрытую инструкцию для ракурсов, действий, одежды, атмосферы, монтажа, переходов, эффектов и аудиоэффектов! ${OMNI_STORYBOARD_FILE_PLACEHOLDER}`,
    "не показывай саму раскадровку в видео: не показывай панели, сетку, номера кадров, разделители, черный фон, служебные подписи, технические подсказки, карточки, коллаж или любой текст с раскадровки как визуальный объект",
    ...
    "каждый кадр раскадровки преврати в полноценную живую сцену видео. если в кадре есть фон, предмет, продукт, перебивка или визуальный эффект, воссоздай его как реальный кадр, а не как картинку, экран, карточку или коллаж внутри видео",
    "сохрани того же персонажа, одежду, внешность, свет и окружение между всеми сценами",
