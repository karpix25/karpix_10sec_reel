...
function buildStoryboardImagePrompt(input: {
  ...
  return [
    "Создай одну квадратную production storyboard картинку, clean director contact sheet из пяти кадров для вертикального UGC видео.",
    ...
    previousStoryboardReferenceUrl
      ...
      : "",
    "На самой картинке обязательно должны быть режиссерские блоки: ЕДИНЫЙ СТИЛЬ, МОНТАЖ, ГОЛОС, SFX, ПРАВИЛО OMNI.",
    "Верхний блок на картинке: ЕДИНЫЙ СТИЛЬ - тот же персонаж, та же одежда, та же локация, тот же свет, телефон 9:16, натуральный UGC.",
    "Второй верхний блок на картинке: МОНТАЖ - 5 кадров по 2 сек, простые резкие склейки, без рекламных эффектов, без музыки.",
    "Левый боковой блок на картинке: ГОЛОС - бодро, живо, как личная рекомендация, без дикторской рекламы.",
    "Правый боковой блок на картинке: SFX - только естественные звуки из кадров, шорох упаковки, стук баночки, звук ложки, тихая комната.",
    "Нижний блок на картинке: ПРАВИЛО OMNI - повторить один основной ряд кадров, прочитать только субтитры этих кадров один раз, музыку не добавлять.",
    "Нельзя рисовать второй мини-ряд, повторную таблицу, thumbnail strip, duplicated frames, duplicated captions или повторять те же 5 кадров внизу.",
    "Слова озвучки должны появиться на картинке только один раз: под пятью основными кадрами. Не повторяй эти фразы в служебных блоках, таблицах или заметках.",
    "Каждый кадр должен быть отдельной визуальной панелью с маленьким номером кадра, таймингом и русской фразой кадра как субтитром.",
    "Можно рисовать только минимальные монтажные и SFX-подсказки, которые помогают повторить раскадровку в видео. Не добавляй интерфейс соцсетей, кнопки приложения, водяные знаки, стрелки-вспышки или рекламные декоративные эффекты.",
    ...
    "Текст на картинке должен быть крупным, коротким и читаемым на русском; не добавляй длинные абзацы.",
