...
import type { OmniVoicePreset } from "./omni-voice-profile";
...
export interface OmniClientAvatar {
  ...
  voice_selection_source: "llm" | "manual" | null;
  kie_audio_id: string | null;
  kie_audio_payload: Record<string, unknown> | null;
  voice_preset?: OmniVoicePreset | null;
  prompt: string;
