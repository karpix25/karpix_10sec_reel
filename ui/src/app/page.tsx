...
export default function CuratorDashboard() {
  ...
  const clientSettings = useMemo<Settings>(
    () => {
      ...
      final_video_project_started_job_count: selectedClient?.final_video_project_started_job_count || 0,
      final_video_automation_stopped_at: selectedClient?.final_video_automation_stopped_at || null,
      final_video_automation_stop_reason: selectedClient?.final_video_automation_stop_reason || null,
