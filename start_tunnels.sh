...
# New DB (tools_baza)
ssh -N -L 5432:10.11.0.22:5432 -o StrictHostKeyChecking=no root@144.91.103.207 &

# Old DB (n8n_ai_avatars)
ssh -N -L 5433:172.20.0.5:5432 -o StrictHostKeyChecking=no root@144.91.103.207 &
