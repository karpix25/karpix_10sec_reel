...
try {
  ...
  assert.equal(normalizedCount(prompt, buildValidStoryboard().voiceoverText), 0);
  assert.equal(normalizedCount(prompt, buildValidStoryboard().frames[0].spokenText), 0);
